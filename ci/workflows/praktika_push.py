...
Builds the praktika and praktika_bootstrap wheels and uploads them to fixed
...
workflow = Workflow.Config(
    ...
    jobs=[
        ...
        Job.Config(
            name="Publish bootstrap wheel",
            runs_on=[RunnerLabels.SMALL_ARM],
            command="bash ./ci/scripts/publish_bootstrap_wheel.sh",
            pre_hooks=[_INSTALL_BUILD],
        ),
    ],
    enable_report=True,
